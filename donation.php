...
<html lang="en">
  <head>
    ...
    <title>Domican College | Donation Page</title>
  </head>
		 ...
		 <nav class="navbar navbar-expand-lg navbar-dark bg-dark position-sticky">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  ...
			  <li class="nav-item active">
				<a class="nav-link" href="index.php#vm#vm">ABOUT US</a>
			  </li>
			  <li class="nav-item active">
...
<!----------Home botton Starts here------------------->
 <a href="#navbar"><i class="fa fa-arrow-alt-circle-up fa-3x" id="home"></i></a>
	...
	<div class="row">
		<div class="col-12">
			<div class="container pt-5">
				<h3 class="text-uppercase shadow p-2">Donate to Support the Project</h3>
				<p class="animated slideInLeft delay-1s">
				...
				<div id="banks">
					...
					<ul class="list-group">
						<li class="list-group-item">
							(i). Cash should be lodged into our Accounts:
					...
					<div id="bank_list " class="pt-4">
						<h4 class="p-2 shadow">Donate to any of these Bank Accounts</h4>
						<h4>First Bank</h4>
						<p>
							Account No:<b> 2003805808 or 3055667213</b>
						</p>
						<h4>Eco Bank</h4>
						<p>
							Account No:<b> 3182011979</b>
						</p>
						<h4>GT Bank Plc.</h4>
						<p>
							Account No:<b> 0029122274</b>
						</p>
